...
// Patched relative to the crates.io 0.1.6 source: an uninhabited enum as the
// extern static's type is unsound (rust-lang/rust#74840) and rejected by
// future rustc. An opaque zero-sized struct gives the same "address only,
// never a value" semantics soundly.
#[repr(C)]
struct Class {
    _opaque: [u8; 0],
}
